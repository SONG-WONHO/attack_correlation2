...
CUDA_VISIBLE_DEVICES=3 python code/train_watermark.py --dataset mnist --arch lenet5 --learning-rate 1e-2 --num-epochs 20 --batch-size 64 --wm-batch-size 8 --wm-type unrelate > sh.wm.mnist.abstract.out
CUDA_VISIBLE_DEVICES=3 python code/train_watermark.py --dataset cifar10 --arch resnet18 --learning-rate 1e-2 --num-epochs 100 --batch-size 64 --wm-batch-size 8 --wm-type unrelate > sh.wm.cifar10.abstract.out
CUDA_VISIBLE_DEVICES=3 python code/train_watermark.py --dataset tiny --arch resnet18 --learning-rate 1e-2 --num-epochs 100 --batch-size 64 --wm-batch-size 8 --wm-type unrelate > sh.wm.tiny.abstract.out
fi