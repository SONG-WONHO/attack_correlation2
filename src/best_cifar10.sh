...
if [ $1 == 4 ]; then
CUDA_VISIBLE_DEVICES=4 python code/train_backdoor_best.py --dataset cifar10 --arch resnet18 --num-epochs 60 --backdoor-type blend --evasion-attack fgsm --evasion-type targeted-np > sh.best.cifar10.3222.out
